...
### Requirements
```
albumentations==1.3.1                             pytorch==2.1.0
augraphy==8.2.6                                   seaborn==0.13.2
jupyter==1.0.0                                    scikit-learn==1.7.2
matplotlib==3.10.8                                timm==0.9.12
numpy==1.26.4                                     torchvision==0.16.0
pandas==2.1.4                                     tqdm==4.65.0
Pillow==9.4.0                                     transformers==4.36.0
python-dotenv==1.2.1                              wandb==0.24.0
```
...
이 특공대는 원본, 메인 모델의 증강본 외에 극악의 3단계 매운맛 노이즈 증강본이 존재한다.<br>
...
│   ├── cascade.py             # ConvNeXt + ConvNeXt Special code 병합 (관리안함)
