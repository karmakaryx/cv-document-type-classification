...
CHECKPOINT_DIR = os.path.join(OUTPUT_PATH, "checkpoints_convspec")
CM_SAVE_DIR = os.path.join(OUTPUT_PATH, "confusionmatrix_convspec")
...
pred_df.to_csv(f"{OUTPUT_PATH}/submission_convspec.csv", index=False)
np.save(f"{OUTPUT_PATH}/probs_convspec.npy", test_probs_avg)
