...
weights[7] = 2.2   # 통원진료확인서
weights[3] = 2.2   # 입퇴원확인서
weights[4] = 2.0   # 진단서
weights[14] = 1.8  # 소견서
weights[12] = 1.5  # 처방전
weights[13] = 1.5  # 이력서
weights[10] = 1.3  # 진료비납입확인서
weights[15] = 1.3  # 자동차등록증
weights[6] = 1.3   # 진료비영수증
weights[11] = 1.3  # 약제비영수증
weights[0] = 1.2   # 계좌번호
...
pred_df.to_csv(f"{OUTPUT_PATH}/output_deit.csv", index=False)
np.save(f"{OUTPUT_PATH}/probs_deit.npy", test_probs_avg)
