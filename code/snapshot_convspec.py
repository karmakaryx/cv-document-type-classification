...
best_ckpt_files = [
    "best_fold0_epoch8.pt",
    "best_fold1_epoch3.pt",
    "best_fold2_epoch8.pt",
    "best_fold3_epoch16.pt",
    "best_fold4_epoch12.pt",
]
...
save_path = f"{OUTPUT_PATH}/submission_convspec_recovery.csv"
submission_df.to_csv(save_path, index=False)

np.save(f"{OUTPUT_PATH}/probs_convspec_recovery.npy", final_probs)
